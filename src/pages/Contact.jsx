    ...
    <div className="">
      ...
      <div className="ml-96 mt-8 pb-2">
        ...
        <div className="flex justify-normal">
          ...
          <div className="pl-80">
            <div className="">
              ...
              <p className="text-gray-700">alym_store@gmail.com</p>
            </div>
            <div>
        ...
        <div className="cursor-pointer mt-6">
          ...
          <h2 className="text-2xl py-3 px-3 font-bold text-black bg-slate-100 mb-2 flex justify-between" onClick={handleClick2}>
            Ошская область
            {open ? <ExpandLess /> : <ExpandMore />}
          </h2>
          ...
          <h2 className="text-2xl py-3 px-3 font-bold text-black bg-slate-100 mb-2 flex justify-between" onClick={handleClick3}>
          ...
          <h2 className="text-2xl py-3 px-3 font-bold text-black bg-slate-100 mb-2 flex justify-between" onClick={handleClick4}>
          ...
          <h2 className="text-2xl py-3 px-3 font-bold text-black bg-slate-100 mb-2 flex justify-between" onClick={handleClick5}>
            Нарынская область
            {open ? <ExpandLess /> : <ExpandMore />}
          </h2>
          ...
          <h2 className="text-2xl py-3 px-3 font-bold text-black bg-slate-100 mb-2 flex justify-between" onClick={handleClick6}>
            Таласская область
            {open ? <ExpandLess /> : <ExpandMore />}
          </h2>
          ...
          <h2 className="text-2xl py-3 px-3 font-bold text-black bg-slate-100 mb-2 flex justify-between" onClick={handleClick7}>
            Баткенская область
            {open ? <ExpandLess /> : <ExpandMore />}
          </h2>
